...
<body>
	<form class="form-horizontal"
		action="<%=request.getContextPath()%>/student/update" method="post">
		<fieldset>
			<!-- Form Name -->
			<legend>Student Profile Update</legend>
			...
			<div class="form-group">
				...
				<input id="studentId" name="studentId" type="hidden"
						placeholder="Name" class="form-control input-md" value="1" required="">
